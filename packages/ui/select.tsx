...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitives.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-[--radius-base] border border-[--border-subtle] bg-transparent px-3 py-2 text-sm text-[--text-primary] transition-none",
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitives.Portal>
    <SelectPrimitives.Content
      ref={ref}
      className={cn(
        "relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-[--radius-lg] border border-[--border-elevated] bg-[--surface-elevated] shadow-[--shadow-elevated] backdrop-blur-[12px] transition-none",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitives.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm text-[--text-primary] transition-none outline-none",
